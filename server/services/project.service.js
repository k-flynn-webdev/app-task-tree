...
const DB_SHOW_PROJECTS = 'SELECT * FROM projects ORDER BY created DESC'
...
const DB_GET_PROJECT_BY_USER = 'SELECT * FROM projects WHERE user = ? ORDER BY created DESC'
const DB_GET_PROJECT_BY_NAME = 'SELECT * FROM projects WHERE name = ? ORDER BY created DESC'
const DB_GET_PROJECTS_BY_IS_DONE = 'SELECT * FROM projects WHERE isDone = ? ORDER BY created DESC'
